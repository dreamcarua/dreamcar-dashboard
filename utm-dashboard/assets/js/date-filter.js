...
(function($) {
    ...
    function restoreFilterFromURL() {
        ...
        if (dateRange) {
            ...
            // Если custom без дат или проектный период - сбросить на yesterday
            if ((dateRange === 'custom' && (!dateFrom || !dateTo)) || dateRange.startsWith('project_')) {
                console.log('📥 Custom без дат или проектный период - сброс на yesterday');
