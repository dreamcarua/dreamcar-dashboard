    ...
    <div class="dashboard-container">
        ...
        <header class="dashboard-header">
            <div class="header-content">
                ...
                <div class="header-title-actions">
                    ...
                    <a href="finance/index.php" class="btn btn-secondary btn-sm">
                        💼 Финансы
                    </a>
                    <?php endif; ?>

                    <!-- Переключатель темы (видно всем) -->
                    <button id="zk-theme-toggle" type="button" title="Переключить тему" aria-label="Переключить тему">
                        <svg class="zk-icon-sun" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <svg class="zk-icon-moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="header-filters">
                ...
                <div class="date-filter">
                    ...
                    <select class="filter-select" id="tariffFilter">
                        ...
                        <option value="Пробний">Пробний (START)</option>
                        <option value="Мінімум">Мінімум (DRIVE)</option>
                        <option value="Базовий">Базовий (BOOST)</option>
                        <option value="Популярний">Популярний (TURBO)</option>
                        <option value="Максимум">Максимум (ULTIMATE)</option>
                ...
                <div class="date-filter">
                    <label>🚦 Трафiк:</label>
                    <select class="filter-select" id="trafficTypeFilter">
                        <option value="all" selected>Весь</option>
                        <option value="paid">💸 Платний</option>
                        <option value="organic">🌱 Органiчний</option>
                    </select>
                </div>
        ...
        <section class="stats-section">
            <div class="stats-grid">
                ...
                <div class="stat-card" title="Количество уникальных людей, совершивших оплату">
                    <div class="stat-icon">&#x1F465;</div>
                    <div class="stat-content">
                        <div class="stat-value" id="totalUniqueBuyers">0</div>
                        <div class="stat-label">Уникальных покупателей</div>
                        <div class="stat-sub" id="totalRepeatBuyersPct" style="display:none;"></div>
                    </div>
                </div>
