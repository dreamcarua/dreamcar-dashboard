...
- ⏸ **Каса відкривається лише для двох пошт** (`kasa_is_allowed()`: `dreamcarua@gmail.com` і пошта Артема). Під `vg@abrisart.com` вона показує нулі. Схоже, так і задумано — але це рішення власника, а не баг. [16.09.2026]
