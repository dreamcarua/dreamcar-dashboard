...
class CrmDeal {
    ...
    public static function getStats($filters = []) {
        ...
        $sql = "SELECT
            ...
            COUNT(DISTINCT CASE WHEN is_paid = 1 THEN COALESCE(NULLIF(TRIM(phone),''), NULLIF(TRIM(email),''), deal_id) END) as unique_buyers
        FROM crm_deals
        $whereStr";
    ...
    private static function getProjectMapping() {
        return [
            ...
            // AUDI E-TRON: новые сделки с 06.05.2026 пишутся в БД как deal_project='AUDI E-TRON'
    ...
    public static function getProjectDates() {
        return [
            ...
            'AUDI E-TRON' => ['date_from' => '2026-05-06', 'date_to' => '2026-05-31'],
        ];
    }
