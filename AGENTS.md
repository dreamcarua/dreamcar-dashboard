...
3. `memory/traps.md` — before the first edit of code, workflow or config. Always. A trap that then changes what you do earns `Memory-Used: traps.md#<slug>` in that commit's message — see Rotation.
